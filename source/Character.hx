...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'wizard':
				tex = Paths.getSparrowAtlas('Wizard_Assets','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'PRODIGY IDLE DANCE', 24);
				animation.addByPrefix('singUP', 'PRODIGY UP NOTE', 24);
				animation.addByPrefix('singRIGHT', 'PRODIGY RIGHT', 24);
				animation.addByPrefix('singDOWN', 'PRODIGY DOWN NOTE', 24);
				animation.addByPrefix('singLEFT', 'PRODIGY LEFT NOTE', 24);
